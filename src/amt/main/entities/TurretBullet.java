...
public class TurretBullet extends Projectile {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.turret, (int)((x - handler.getCamera().xOffset()) * Assets.tileWidth), (int)((y - handler.getCamera().yOffset()) * Assets.tileHeight), Assets.tileWidth, Assets.tileHeight, null);
    }
}
